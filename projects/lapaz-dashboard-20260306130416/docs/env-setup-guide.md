...
```
projects/lapaz-crawl-20260305170615/.env
```
...
```bash
# projects/lapaz-dashboard-20260306130416/backend/.env
...
RAG 관련 키(ANTHROPIC, VOYAGE, SUPABASE)는 `lapaz-crawl-20260305170615/.env`에 이미 설정되어 있으므로 중복 설정 불필요.

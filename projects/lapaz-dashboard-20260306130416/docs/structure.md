...
```
projects/lapaz-dashboard-20260306130416/
├── docs/
...
기존 `projects/lapaz-crawl-20260305170615/src/rag/pipeline.py`를 `sys.path`에 추가하여 직접 import.

```python
# backend/services/rag_service.py 개요
import sys
sys.path.insert(0, "../../lapaz-crawl-20260305170615/src")

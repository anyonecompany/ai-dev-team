...
기존 RAG 코드 위치: `projects/lapaz-crawl-20260305170615/src/rag/`
...
RAG_PROJECT_ROOT = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..", "lapaz-crawl-20260305170615", "src")
)
...
- 따라서 `.env` 파일은 반드시 `lapaz-crawl-20260305170615/.env` 위치에 존재해야 함
